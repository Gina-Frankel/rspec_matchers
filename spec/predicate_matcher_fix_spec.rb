...
describe do
  it "outputs a welcome greeting" do
    expect { greeting }.to output("hello, welcome to the tea shop").to_stdout
  end
end
...
subject(:green_tea){described_class.new}
  ...
  describe "#hot?" do
    ...
    describe "#tea_review" do
      ...
      expect{green_tea.tea_review}.to output("this is delicious")
    end
  end

  describe "#return_ingredients" do
    it "includes water as an ingredient" do
      expect(black_tea.return_ingredients).to include("water")
    end
  end
